...
export const ecluseFixture: z.input<typeof modelSchema> = {
  ...
  diagrams: [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          name: 'Écluse proxy',
          description:
            'The request pipeline: router, parallel upstream fetch, packument merge, deny-by-default rules and integrity gate, then serve. It relays publishes. It holds forwarded caller credentials transiently. It polls S3 for OSV db updates and performs an atomic shadow-swap for CVE boundaries.',
          outOfScope: false,
          reasonOutOfScope: '',
          position: {
            x: 530,
        ...
        {
          kind: 'process',
          id: '0ec10e5e-0000-4000-8000-000000000021',
          name: 'Mirror worker',
          description:
            "The demand-driven asynchronous worker. It polls the mirror queue, back-fills the approved artifact from the upstream registry, and verifies the bytes against dist.integrity. It then publishes to the mirror store with Écluse's own minted write token.",
          outOfScope: false,
          reasonOutOfScope: '',
          position: {
            x: 350,
        ...
        {
          kind: 'process',
          id: '0ec10e5e-0000-4000-8000-000000000022',
          name: 'Credential provider',
          description:
            "It mints and refreshes the mirror-target write token under the container or task role, through CodeArtifact GetAuthorizationToken, with single-flight and a breaker. This is Écluse's only standing credential.",
          outOfScope: false,
          reasonOutOfScope: '',
          position: {
            x: 635,
        ...
        },
        {
          ...
          source: {
            kind: 'attached',
            element: '0ec10e5e-0000-4000-8000-000000000021',
          },
          target: {
            kind: 'attached',
            element: '0ec10e5e-0000-4000-8000-000000000031',
        ...
        {
          kind: 'process',
          id: 'f66e2ffa-c6bf-4b45-8aad-a23ced3a97ff',
          name: 'Écluse Dredger',
          description:
            'A separate reaper service. It continually prunes the private mirror (Registry B) of cold inventory (AgeSinceMirror) or vulnerable versions (HasAdvisoryAboveThreshold). It takes zero ingress, shares ecluse-core for the rules, and deletes from the trusted store.',
          outOfScope: false,
          reasonOutOfScope: '',
          position: {
            x: 400,
        ...
        },
        {
          ...
          source: {
            kind: 'attached',
            element: 'f66e2ffa-c6bf-4b45-8aad-a23ced3a97ff',
          },
          target: {
            kind: 'attached',
            element: '0ec10e5e-0000-4000-8000-000000000034',
  ...
  threats: [
    {
      id: '0ec10e5e-0000-4000-8000-00000000010c',
      number: 12,
      title:
        'Upstream registry forges its own server-asserted metadata (e.g. a backdated publish time)',
      category: {
        methodology: 'STRIDE',
        category: 'tampering',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000011'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000101',
      number: 1,
      title: 'Forwarded caller credentials aggregated in proxy memory',
      category: {
        methodology: 'STRIDE',
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000020'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000102',
      number: 2,
      title: 'Chokepoint exhaustion via pathological upstream payload',
      category: {
        methodology: 'STRIDE',
    ...
    {
      id: '32d813d8-6bee-4fa3-acb2-d62efe5aff18',
      number: 18,
      title: 'Proxy compromised via tampered OSV database',
      category: {
        methodology: 'STRIDE',
        category: 'tampering',
      },
    ...
    {
      id: '0ec10e5e-0000-4000-8000-000000000109',
      number: 9,
      title:
        'Cross-client disclosure of a private package via shared cache (#115)',
      category: {
        methodology: 'STRIDE',
        category: 'information-disclosure',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000030'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010b',
      number: 11,
      title: 'Undetected artifact substitution across upstreams',
      category: {
        methodology: 'STRIDE',
        category: 'tampering',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000032'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010f',
      number: 15,
      title:
        'Private-upstream aggregation admits the public registry, bypassing the gate',
      category: {
        methodology: 'STRIDE',
        category: 'tampering',
      },
    ...
    {
      id: '0ec10e5e-0000-4000-8000-00000000010a',
      number: 10,
      title: 'Registry collapse erases provenance and per-store policy',
      category: {
        methodology: 'STRIDE',
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000034'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010d',
      number: 13,
      title:
        'Malicious mirrored version persists and is served as trusted (no automatic post-ingestion revocation)',
      category: {
        methodology: 'STRIDE',
        category: 'tampering',
      },
    ...
    {
      id: '0ec10e5e-0000-4000-8000-000000000103',
      number: 3,
      title: 'Off-by-default edge auth assumes a sound network boundary',
      category: {
        methodology: 'STRIDE',
        category: 'spoofing',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000040'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000123',
      number: 23,
      title: 'Package-name spoofing via invisible characters',
      category: {
        methodology: 'STRIDE',
        category: 'spoofing',
      },
    ...
    {
      id: '0ec10e5e-0000-4000-8000-000000000124',
      number: 24,
      title: 'Package-name typosquatting within the permitted character set',
      category: {
        methodology: 'STRIDE',
        category: 'spoofing',
      },
    ...
    {
      id: '0ec10e5e-0000-4000-8000-000000000104',
      number: 4,
      title: 'Caller credential leak to the public upstream',
      category: {
        methodology: 'STRIDE',
        category: 'information-disclosure',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000043'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000105',
      number: 5,
      title: 'SSRF via crafted identifier or upstream-declared dist.tarball',
      category: {
        methodology: 'STRIDE',
    ...
    {
      id: '0ec10e5e-0000-4000-8000-000000000110',
      number: 16,
      title:
        'Connect-time reachability/timing oracle for an attacker-controlled allowlisted DNS',
      category: {
        methodology: 'STRIDE',
        category: 'information-disclosure',
      },
    ...
    {
      id: '0ec10e5e-0000-4000-8000-000000000106',
      number: 6,
      title: 'Package shadowing via first-party publish',
      category: {
        methodology: 'STRIDE',
        category: 'tampering',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000044'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010e',
      number: 14,
      title: 'SSRF via the worker back-fill fetch (a blind sink)',
      category: {
        methodology: 'STRIDE',
        category: 'elevation-of-privilege',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000047'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000108',
      number: 8,
      title: 'SSRF to the instance-metadata credential endpoint',
      category: {
        methodology: 'STRIDE',
        category: 'elevation-of-privilege',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-000000000049'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000107',
      number: 7,
      title:
        'Mirror-write credential is a standing privilege over the trusted store',
      category: {
        methodology: 'STRIDE',
        category: 'elevation-of-privilege',
      },
      ...
      elements: ['0ec10e5e-0000-4000-8000-00000000004a'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000111',
      number: 22,
      title:
        'Mirror-write credential can be sent to a misconfigured registry target',
      category: {
        methodology: 'STRIDE',
        category: 'information-disclosure',
      },
    ...
    {
      id: '3735906e-a06a-4e0f-ba45-894ba5400ce8',
      number: 20,
      title: 'Pathological OSV Payload (DoS)',
      category: {
        methodology: 'STRIDE',
        category: 'denial-of-service',
      },
    ...
    {
      id: '43f60aec-7a7c-4450-8992-ae2b42d20b0f',
      number: 25,
      title: 'Dredger inappropriately purges valid packages',
      category: {
        methodology: 'STRIDE',
        category: 'denial-of-service',
      },
    ...
    {
      id: 'c12bddfe-96d4-47c6-92e0-a961abadb5b2',
      number: 26,
      title: 'Dredger container-role privilege escalation',
      category: {
        methodology: 'STRIDE',
        category: 'elevation-of-privilege',
      },
    ...
    {
      id: 'e23cddfe-96d4-47c6-92e0-a961abadb5b3',
      number: 28,
      title: 'First-party data loss from collapsed registries',
      category: {
        methodology: 'STRIDE',
        category: 'denial-of-service',
      },
    ...
    {
      id: '0c922ee5-3ac6-4a85-89de-91feecf0f9f7',
      number: 21,
      title: 'Massive Purge DoS',
      category: {
        methodology: 'STRIDE',
        category: 'denial-of-service',
      },
  ...
  mitigations: [
    {
      id: '0ec10e5e-0000-4000-8000-000000000101-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000101'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000102-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000102'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000103-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000103'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000104-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000104'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000105-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000105'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000106-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000106'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000107-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000107'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000108-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000108'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000109-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000109'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010a-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-00000000010a'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010b-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-00000000010b'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010c-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['0ec10e5e-0000-4000-8000-00000000010c'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010d-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['0ec10e5e-0000-4000-8000-00000000010d'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010e-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-00000000010e'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-00000000010f-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-00000000010f'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000110-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['0ec10e5e-0000-4000-8000-000000000110'],
    },
    {
    ...
    {
      id: '32d813d8-6bee-4fa3-acb2-d62efe5aff18-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['32d813d8-6bee-4fa3-acb2-d62efe5aff18'],
    },
    {
      id: '3735906e-a06a-4e0f-ba45-894ba5400ce8-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['3735906e-a06a-4e0f-ba45-894ba5400ce8'],
    },
    {
      id: '0c922ee5-3ac6-4a85-89de-91feecf0f9f7-mitigation',
      title: '',
      prose:
        "Not yet built. Dredger's deletion logic must be explicitly batched and rate-limited.",
      status: 'proposed',
      threats: ['0c922ee5-3ac6-4a85-89de-91feecf0f9f7'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000111-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000111'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000123-mitigation',
      title: '',
      prose:
      ...
      status: 'implemented',
      threats: ['0ec10e5e-0000-4000-8000-000000000123'],
    },
    {
      id: '0ec10e5e-0000-4000-8000-000000000124-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['0ec10e5e-0000-4000-8000-000000000124'],
    },
    {
      id: '43f60aec-7a7c-4450-8992-ae2b42d20b0f-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['43f60aec-7a7c-4450-8992-ae2b42d20b0f'],
    },
    {
      id: 'c12bddfe-96d4-47c6-92e0-a961abadb5b2-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['c12bddfe-96d4-47c6-92e0-a961abadb5b2'],
    },
    {
    ...
    {
      id: 'e23cddfe-96d4-47c6-92e0-a961abadb5b3-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['e23cddfe-96d4-47c6-92e0-a961abadb5b3'],
    },
    {
    ...
    {
      id: '0b32b3e5-74f1-421c-8c9b-92a24fd2a00b-mitigation',
      title: '',
      prose:
      ...
      status: 'proposed',
      threats: ['0b32b3e5-74f1-421c-8c9b-92a24fd2a00b'],
    },
  ],
  assumptions: [],
};
