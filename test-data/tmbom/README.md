...
schema. The repository formatter controls whitespace. The Vault scope
description normalises dash punctuation.
...
without declaring either trust zone. Those references remain unchanged in this
negative fixture. Import refuses them.
