...
export const fieldsFrCA = catalogue(fieldMessages)('fr-CA')({
  ...
  'existing-threat': 'Menace existante',
  'attach-existing-threat': 'Rattacher une menace existante',
  'choose-existing-threat-first': 'Choisissez d’abord une menace existante.',
  'existing-element': 'Élément existant',
