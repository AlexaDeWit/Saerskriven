...
export const divergenceFrCA = catalogue(divergenceMessages)('fr-CA')({
  ...
  'tmbom-data-set-as-prose':
    'Le jeu de données « {name} » devient de la prose sur ses magasins de données. L’identité partagée des données n’est pas conservée.',
  'tmbom-data-set-dropped':
    'Le jeu de données « {name} » n’a aucun placement sur un magasin de données et n’est pas conservé.',
  'field-not-retained':
